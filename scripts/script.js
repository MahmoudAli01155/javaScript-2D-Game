window.addEventListener("load", function () {
  ...
  class Game {
    constructor(width, height) {
      ...
      this.particles = [];
      this.enemyTimer = 0;
      this.enemyInterval = 2000; //this tow properties to create every 1s enemy   
      this.gameOver = false;
      this.ammo = 20;
      this.maxAmmo = 50;
      this.ammoTimer = 0;
      this.ammoInterval = 350; // shoots refill after half a second
      this.score = 0;
      this.winningScore = 80;
      this.gameTime = 0; // time counter
      this.timeLimit = 30000; //time of the game
